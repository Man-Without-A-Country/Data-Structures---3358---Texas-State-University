...
namespace seqOfItem  = CS3358_SP16_A04_sequenceOfItem;
...
{
   seqOfItem::sequence<double> s1;  // A sequence of double for testing
   seqOfItem::sequence<char> s2; // A sequence of char for testing
